                            ...
                            <div class="col-md-12">
                                <section class="panel">
                                    <header class="panel-heading">
                                        ...
                                        <h2 class="panel-title">Modifier catégorie</h2>
                                    </header>
                                    <form class="form-horizontal form-bordered" action="/Mediatheque/ModifierParamServlet" method="post">

                                        <input  id="idcategorie" name="idcategorie" value="${categorie.idcategorie}" type="hidden" >

                                        <div class="panel-body">
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label" for="inputDefault">Libellé Catégorie</label>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" id="categorie" name="categorie" required value="${categorie.libeleCat}">
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-12">
                                <section class="panel">
                                    <header class="panel-heading">
                                        ...
                                        <h2 class="panel-title">Modifier thème</h2>
                                    </header>

                                    <form class="form-horizontal form-bordered" action="/Mediatheque/ModifierParamServlet" method="post">

                                        <input  id="idtheme" name="idtheme" value="${theme.idTheme}" type="hidden" >

                                        <div class="panel-body">
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label" for="inputDefault">Libellé Thème</label>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" id="theme" name="theme" required value="${theme.libeleTheme}">
                                                </div>
                                            </div>
